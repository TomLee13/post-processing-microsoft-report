...
#Brief Description: This is a program for final project activity #2.

# Define a main function that will finish activity #1 and #2 when called.
def main():
...
# Define a function which deletes all the punctuation in the text.
